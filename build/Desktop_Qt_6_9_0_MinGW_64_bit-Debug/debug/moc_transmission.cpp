...
template <> constexpr inline auto Transmission::qt_create_metaobjectdata<qt_meta_tag_ZN12TransmissionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'guiEvent'
        QtMocHelpers::SignalData<void(const GuiEvent &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
        // Signal 'logLine'
...
void Transmission::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->guiEvent((*reinterpret_cast< std::add_pointer_t<GuiEvent>>(_a[1]))); break;
        case 1: _t->logLine((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->checksumReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->ackRequest((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        case 4: _t->ackAnimFinished((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 5: _t->finishImmediately(); break;
        case 6: _t->timeout(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Transmission::*)(const GuiEvent & )>(_a, &Transmission::guiEvent, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Transmission::*)(const QString & )>(_a, &Transmission::logLine, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Transmission::*)(const QString & )>(_a, &Transmission::checksumReady, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Transmission::*)(int , bool )>(_a, &Transmission::ackRequest, 3))
            return;
    }
}
...
// SIGNAL 0
void Transmission::guiEvent(const GuiEvent & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Transmission::logLine(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Transmission::checksumReady(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void Transmission::ackRequest(int _t1, bool _t2)
{
